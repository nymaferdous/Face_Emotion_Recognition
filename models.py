...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=7, isfc=True):
...
def ResNet18(n_classes=7):
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=n_classes)


def ResNet34(n_classes=4022, isfc=True):
    return ResNet(BasicBlock, [3, 4, 6, 3], num_classes=n_classes, isfc=isfc)


def ResNet50(n_classes=29500):
    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes=n_classes)


def ResNet101(n_classes=29500):
    return ResNet(Bottleneck, [3, 4, 23, 3], num_classes=n_classes)


def ResNet152(n_classes=29500):
